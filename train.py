...
AUGMENTATION_CONFIG = AugmentationConfig(
    ...
    mosaic=0.0,                      # Mosaic: 4 зображення в одне (0-1)
    close_mosaic=5,                  # Вимкнути Mosaic в останніх N епохах
    mixup=0.0,                       # MixUp: альфа-блендинг 2 зображень (0-1)
    cutmix=0.0,                      # CutMix: вирізання регіону з іншого зображення (0-1)
    ...
    noise=0.0,                       # Ймовірність шуму (0-1)
    ...
    scale=0.0,                       # Масштаб (+/- scale, 0.5 = від 0.5x до 1.5x)
